...
class GUMP
{
        ...
        foreach ($this->errors as $e) {
            ...
            switch ($e['rule']) {
                ...
                case 'validate_min_age':
                    ...
                    break;
                case 'validate_valid_time_hhmm':
                    $resp[] = "The <span class=\"$field_class\">$field</span> field need format time (HH:MM)";
                    break;
                default:
        ...
        foreach ($this->errors as $e) {
            ...
            switch ($e['rule']) {
                ...
                case 'validate_min_age':
                    ...
                    break;
                case 'validate_valid_time_hhmm':
                    $resp[$field] = "The $field field need format time (HH:MM)";
                    break;
                default:
    ...
    */
    ...
    /**
     *
     * * Usage: '<index>' => 'valid_time_hhmm'
     * @access protected
     * @param  string $field
     * @param  array $input
     * @return mixed
     */
    protected function validate_valid_time_hhmm($field, $input, $param = NULL)
    {
        if(!isset($input[$field])|| empty($input[$field]))
        {
            return;
        ...
        if (!preg_match("#([0-1]{1}[0-9]{1}|[2]{1}[0-3]{1}):[0-5]{1}[0-9]{1}#", $input[$field])) {
